...
const PERINATAL_DATA = {
  ...
  milnacipran:          { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Very limited human pregnancy data. Approved for fibromyalgia, not MDD. Avoid unless clearly necessary.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'Insufficient human data. Avoid unless no alternative.' } },
  ...
  vortioxetine:         { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Limited human data. Novel mechanism. Avoid unless benefit clearly outweighs risk.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No published human lactation data.' } },
  ...
  zuranolone:           { pregnancy: { fdaCategory: 'N/A', risk: 'unknown', notes: 'PLLR-era label only. Animal data shows fetal harm. Contraceptive use required. Very limited human data.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'avoid', notes: 'No human lactation data. Neuroactive steroid — avoid.' } },
  ...
  perphenazine:         { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Neonatal EPS, sedation. Some use in refractory hyperemesis. Limited data.' }, breastfeeding: { rid: 'Not established', hale: 'L3', risk: 'caution', notes: 'Low milk concentrations in limited studies. Monitor infant.' } },
  ...
  quetiapine:           { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Gestational diabetes risk. Neonatal withdrawal. Commonly used; limited teratogenicity signal.' }, breastfeeding: { rid: '0.07–0.1%', hale: 'L4', risk: 'avoid', notes: 'Higher milk transfer than olanzapine/risperidone. Significant sedation risk. Avoid; use alternative.' } },
  ...
  clozapine:            { pregnancy: { fdaCategory: 'B', risk: 'caution', notes: 'Category B but agranulocytosis monitoring required. Neonatal hypotonia, seizures reported. Reserve for refractory illness.' }, breastfeeding: { rid: 'Not established', hale: 'L3', risk: 'avoid', notes: 'Risk of infant agranulocytosis and sedation. Avoid; if used, monitor infant CBC.' } },
  ziprasidone:          { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Limited data. QT prolongation consideration. No strong teratogenicity signal.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No reliable lactation data. Avoid if alternative exists.' } },
  lurasidone:           { pregnancy: { fdaCategory: 'B', risk: 'low',     notes: 'Category B — animal studies reassuring. Limited human data. Neonatal EPS/withdrawal possible.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No published human lactation data. Caution warranted.' } },
  ...
  paliperidone:         { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Active metabolite of risperidone. Neonatal EPS/withdrawal. Similar concerns to risperidone.' }, breastfeeding: { rid: 'Not established', hale: 'L3', risk: 'caution', notes: 'Detected in milk (similar to risperidone). Monitor infant.' } },
  ...
  brexpiprazole:        { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Limited data. Long half-life. Neonatal EPS/withdrawal possible.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No human lactation data. Long half-life a concern.' } },
  cariprazine:          { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Very limited data. Ultra-long half-life of DCAR metabolite (~1–3 weeks) is a concern.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'avoid', notes: 'No data; ultra-long-acting metabolite would persist in infant for weeks. Avoid.' } },
  lumateperone:         { pregnancy: { fdaCategory: 'N/A', risk: 'unknown', notes: 'PLLR label only. Limited human data. Avoid unless clearly necessary.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No human lactation data.' } },
  ...
  ramelteon:            { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Melatonin receptor agonist. Limited human data. Animal data shows reproductive effects at high doses.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No human lactation data. Melatonin itself is present in breast milk naturally; drug form unstudied.' } },
  suvorexant:           { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Orexin antagonist. Limited human data. Avoid chronic use in pregnancy.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No published lactation data.' } },
  // Benzodiazepines
  ...
  // Other anxiolytics
  buspirone:            { pregnancy: { fdaCategory: 'B', risk: 'low',     notes: 'Category B. Animal studies reassuring. Limited human data but no strong teratogenicity signal. First-line anxiolytic consideration in pregnancy.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No published human lactation data. Short half-life may be favorable, but data lacking.' } },
  ...
  clonidine:            { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Neonatal hypotension, rebound hypertension if abruptly stopped. Used for ADHD/HTN; weigh benefit vs. risk.' }, breastfeeding: { rid: 'Not established', hale: 'L3', risk: 'caution', notes: 'Excreted in milk; neonatal sedation and hypotension possible.' } },
  ...
  dexmethylphenidate:   { pregnancy: { fdaCategory: 'C', risk: 'caution', notes: 'Active enantiomer of methylphenidate. Same concerns apply.' }, breastfeeding: { rid: 'Not established', hale: 'L3', risk: 'caution', notes: 'Same as methylphenidate. Monitor infant.' } },
  ...
  lisdexamfetamine:     { pregnancy: { fdaCategory: 'C', risk: 'avoid',   notes: 'Prodrug of d-amphetamine. Same pregnancy concerns. Avoid.' }, breastfeeding: { rid: 'Not established', hale: 'L4', risk: 'avoid', notes: 'Prodrug — converts to d-amphetamine. Avoid breastfeeding.' } },
  modafinil:            { pregnancy: { fdaCategory: 'C', risk: 'avoid',   notes: 'Facial cleft signal in post-marketing data. Manufacturer recommends effective contraception. Avoid in pregnancy.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No published lactation data. Avoid given teratogenicity concerns.' } },
  armodafinil:          { pregnancy: { fdaCategory: 'C', risk: 'avoid',   notes: 'R-enantiomer of modafinil. Same facial cleft concern and contraception requirement.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No lactation data. Avoid.' } },
  solriamfetol:         { pregnancy: { fdaCategory: 'N/A', risk: 'unknown', notes: 'PLLR label. Very limited data. Dopamine/norepinephrine reuptake inhibitor — neonatal effects unknown.' }, breastfeeding: { rid: 'Not established', hale: 'unknown', risk: 'unknown', notes: 'No human lactation data.' } },
