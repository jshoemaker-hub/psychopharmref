...
function switchSection(id) {
  ...
  if (sec && sec.dataset.lazyTool && !sec.dataset.lazyLoaded) {
    ...
    link.rel = 'stylesheet';
    link.href = 'css/tools/' + toolId + '.css?v=20260719c';
    ...
    function loadToolScript() {
      ...
      if (toolId === 'question-bank-tool' && !window.QBANK_DATA) {
        ...
        dataScript.src = 'js/qbank-data.js?v=20260719c';
        dataScript.onload = function() {
          var script = document.createElement('script');
          script.src = 'js/tools/' + toolId + '.js?v=20260719c';
        ...
        var deps = [
          'js/combination-strategies.js?v=20260719c',
          'js/receptor-actions.js?v=20260719c',
          'js/mechanism-tiers.js?v=20260719c',
          'js/pair-safety.js?v=20260719c',
          'js/symptom-domains.js?v=20260719c'
        ];
    ...
    var toolUtilsRequirements = {
      'phq9-tool': ['createScaleTool'],
      'gad7-tool': ['createScaleTool'],
      'ess-tool': ['createScaleTool'],
      'msibpd-tool': ['createScaleTool'],
      'bprs-tool': ['loadClinicalScale'],
      'pcl5-tool': ['loadClinicalScale'],
      'ymrs-tool': ['loadClinicalScale'],
      'ybocs-tool': ['loadClinicalScale'],
      'aims-tool': ['loadClinicalScale'],
      'bfcrs-tool': ['loadClinicalScale'],
      'asrs-tool': ['loadClinicalScale'],
    ...
    function shouldLoadToolUtils() {
      if (!window.ToolUtils) return true;
      var requirements = toolUtilsRequirements[toolId] || [];
      for (var i = 0; i < requirements.length; i++) {
        if (typeof window.ToolUtils[requirements[i]] !== 'function') return true;
      }
      return false;
    }
    ...
    if (shouldLoadToolUtils()) {
      ...
      utils.src = 'js/tools/tool-utils.js?v=20260719c';
