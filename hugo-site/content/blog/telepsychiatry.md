...
<div class="ba-body">
        ...
        <div class="ba-stat-row">
          <div class="ba-stat-card">
            <div class="ba-stat-label">Telehealth Depression Remission Rate</div>
            <div class="ba-stat-value">40–50%</div>
          </div>
          <div class="ba-stat-card">
            <div class="ba-stat-label">Patient Satisfaction With Telehealth</div>
            <div class="ba-stat-value">60–75%</div>
          </div>
          <div class="ba-stat-card">
            <div class="ba-stat-label">Telehealth MAT Adherence Advantage</div>
            <div class="ba-stat-value">10–20% higher</div>
          </div>
        </div>
        ...
        <p>
          ...
          <br></br>(2) **Bimonthly in-person, alternate telehealth:** In-person every other visit, alternating with brief telehealth check-ins. Higher engagement; closer relationship.
          <br></br>(3) **As-needed hybrid:** Routine telehealth with option for in-person when patient requests or clinician detects need (emerging symptoms, unclear diagnosis, medication adjustment requiring careful observation).
        </p>
        ...
        <div class="ba-references">
          ...
          <ol class="ba-ref-list">
            <li>Chérestal F, Basset L. History of telepsychiatry: From early telemedicine to modern virtual care. *Telemed J E Health*. 2021;27(8):825–832.</li>
            <li>Delphin-Combe F, Rojas-Brezmes C, Julien-Sweerts S, et al. Telepsychiatry outcomes in depression: A systematic review and meta-analysis. *Front Psychiatry*. 2021;12:671080.</li>
            <li>Shore JH, Yellowlees PM, Caudill RL, et al. Best practices in videoconferencing-based telemental health. *Telemed J E Health*. 2018;24(8):605–613.</li>
            <li>Department of Justice, Drug Enforcement Administration. Guidelines for telemedicine prescribing of controlled substances. Federal Register. 2023.</li>
            <li>Substance Abuse and Mental Health Services Administration (SAMHSA). Updates on Buprenorphine Telemedicine Prescribing Policy. SAMHSA.gov; 2024.</li>
            <li>Centers for Medicare & Medicaid Services (CMS). Medicare Telemedicine Health Care Provider Fact Sheet. CMS.gov; 2024.</li>
            <li>Association of Administrators of the Interstate Compact (AAPI). Expedited Licensure Compact: Interstate medical practice. AAPI.org; 2024.</li>
            <li>Fortney JC, Pyne JM, Kimbrell TA, et al. Telemedicine-based collaborative care for posttraumatic stress disorder: A randomized clinical trial. *JAMA Psychiatry*. 2015;72(1):58–67.</li>
            <li>Volkow ND, Frattaroli MV, Swanson JM. Stimulant medications and potential for abuse. *ADHD Atten Deficit Hyperact Disord*. 2020;12(2):143–156.</li>
            <li>Wakeman SE, Larochelle MR, Ameli O, et al. Comparative effectiveness of telephone-based buprenorphine vs office-based buprenorphine plus opioid use disorder treatment in the ASPIRE randomized trial. *JAMA Intern Med*. 2020;180(1):48–57.</li>
            <li>Pierce BS, Perrin PB, Tyler CM, et al. The COVID-19 telepsychiatry revolution: Psychiatric care transformed overnight. *Am J Psychiatry*. 2020;177(6):490–491.</li>
            <li>American Psychiatric Association. Telepsychiatry competencies in an evolving landscape: Guidelines for the digitally engaged psychiatrist. *Am J Psychiatry*. 2021.</li>
            <li>Office for the Protection of Research Subjects (OPRS). HIPAA compliance and telemedicine. HHS.gov; updated 2024.</li>
            <li>Morimoto T, Asano K, Yamada N, et al. Observational study of the impact of telehealth on wait times and access to psychiatry in a university hospital. *J Telemed Telecare*. 2021;27(4):236–244.</li>
            <li>AMA (American Medical Association). Current procedural terminology (CPT) telehealth modifiers and coding guidance. AMA.org; 2024.</li>
            <li>National Alliance on Mental Illness (NAMI). Telehealth access and equity: Addressing the digital divide in psychiatry. NAMI.org; 2023.</li>
          </ol>
        </div>
