---
title: "Motivational Interviewing: Principles, Techniques, and Clinical Application | PsychoPharmRef"
date: 2026-03-20
description: ""
category: ""
subtitle: "OARS, change talk, the spirit of MI, and practical applications across substance use, medication adherence, and health behavior change"
readTime: "15 min read"
clinicalSummary: ""
related: ['smoking-cessation', 'alcohol-use-disorder', 'opioid-use-disorder', 'psychotherapy-overview']
draft: false
---
...
<div class="ba-body">
        ...
        <div class="ba-timeline">
          ...
          <div class="ba-tl-item">
            <div class="ba-tl-dot"></div>
            <div class="ba-tl-text">
              <div class="ba-tl-time">1991</div>
              **Miller & Rollnick's First Edition**
              Stephen Rollnick and William Miller published "Motivational Interviewing: Preparing People to Change Addictive Behavior" (Guilford Press). This seminal text formalized MI approach and made it accessible beyond single-site research. Included the concept of "rolling with resistance" and "developing discrepancy" as core principles.
            </div>
          </div>
          ...
          <div class="ba-tl-item">
            <div class="ba-tl-dot"></div>
            <div class="ba-tl-text">
              <div class="ba-tl-time">2002</div>
              **MINT (Motivational Interviewing Network of Trainers) Established**
              The MINT international training network was formalized, creating standards for MI trainer certification and competency assessment. MINT brought structure to MI training, reducing variance in quality and ensuring fidelity to core principles.
            </div>
          </div>
          ...
          <div class="ba-tl-item">
            ...
            <div class="ba-tl-text">
              ...
              **COMBINE Trial: MI in Alcohol Dependence**
              The COMBINE study (Combining Medications and Behavioral Interventions for Alcoholism) tested naltrexone +/- acamprosate with or without combined behavioral intervention (CBT + MI). Results showed modest but real additive benefit of behavioral therapy including MI component to pharmacotherapy alone.
            </div>
          </div>
          ...
          <div class="ba-tl-item">
            <div class="ba-tl-dot"></div>
            <div class="ba-tl-text">
              <div class="ba-tl-time">2012</div>
              **Miller & Rollnick Third Edition**
          ...
          <div class="ba-tl-item">
            ...
            <div class="ba-tl-text">
              ...
              **Integration into Standard Treatment Protocols**
              MI is now explicitly incorporated into evidence-based treatment for substance use (SAMHSA guidelines), medication non-adherence, smoking cessation, weight management, and psychosis engagement. Training is standard in addiction medicine, psychiatry, and primary care residencies.
            </div>
          </div>
        ...
        <ul style="margin: 16px 0;">
          <li>**Desire:** "I want to quit drinking."</li>
          <li>**Ability:** "I think I can do this." "I've done harder things."</li>
          <li>**Reasons:** "My kids need me healthy." "I'll have more energy."</li>
          <li>**Need:** "I have to change or I'll lose my job."</li>
          <li>**Commitment:** "I'm going to do this." "I've decided."</li>
          <li>**Activation:** "I'm ready to take action."</li>
          <li>**Taking Steps:** "I've already enrolled in counseling." "I threw out my cigarettes."</li>
        </ul>
        ...
        <div class="ba-stat-row">
          <div class="ba-stat-card">
            <div class="ba-stat-label">MI NNT for Substance Use Reduction</div>
            <div class="ba-stat-value">5–10</div>
          </div>
          <div class="ba-stat-card">
            <div class="ba-stat-label">MI Smoking Quit Rates</div>
            <div class="ba-stat-value">25–35%</div>
          </div>
          <div class="ba-stat-card">
            <div class="ba-stat-label">Effect Size vs. Advice (Meta-analysis)</div>
            <div class="ba-stat-value">d=0.30–0.50</div>
          </div>
        </div>
        ...
        <div class="ba-references">
          ...
          <ol class="ba-ref-list">
            <li>Miller WR. Motivational interviewing with problem drinkers. *Behav Psychother*. 1983;11(2):147–172.</li>
            <li>Miller WR, Rollnick S. *Motivational Interviewing: Preparing People to Change Addictive Behavior.* Guilford Press; 1991.</li>
            <li>Project MATCH Research Group. Matching alcoholism treatments to client heterogeneity. *J Stud Alcohol*. 1997;58(1):7–29.</li>
            <li>Miller WR, Rollnick S. *Motivational Interviewing: Helping People Change.* 3rd ed. Guilford Press; 2012.</li>
            <li>Moyers TB, Martin T, Christopher PJ, Houck JM. Client language as a mediator of motivational interviewing efficacy. *J Consult Clin Psychol*. 2007;75(6):878–884.</li>
            <li>Deci EL, Ryan RM. Self-determination theory: A macrotheory of human motivation, development, and health. *Can Psychol*. 2008;49(3):182–185.</li>
            <li>Prochaska JO, DiClemente CC. Stages and processes of self-change of smoking: toward an integrative model of change. *J Consult Clin Psychol*. 1983;51(3):390–395.</li>
            <li>Arkowitz H, Miller WR, Rollnick S. *Motivational Interviewing in the Treatment of Psychological Problems.* 2nd ed. Guilford Press; 2015.</li>
            <li>Vasilaki EI, Hosier SG, Cox WM. The efficacy of motivational interviewing as a brief intervention for excessive drinking: A meta-analytic review. *Alcohol Alcohol*. 2006;41(3):328–335.</li>
            <li>Stead LF, Buitrago D, Preciado N, et al. Physician advice for smoking cessation. *Cochrane Database Syst Rev*. 2013;5:CD000165.</li>
            <li>Treasure JL, Sepulveda AR. The assessment of motivation to change in eating disorders: A review. *Eur Eat Disord Rev*. 2013;21(4):295–301.</li>
            <li>Substance Abuse and Mental Health Services Administration (SAMHSA). Motivational Interviewing in Substance Use Disorders. SAMHSA Publication; 2019.</li>
            <li>Moyers TB, Houck J. Combining motivational interviewing and cognitive behavioral therapy: A randomized clinical trial of treatment for marijuana use. *Psychol Addict Behav*. 2011;25(4):688–697.</li>
            <li>Rollnick S, Miller WR, Butler CC. *Motivational Interviewing in Health Care: Helping Patients Change Behavior.* Guilford Press; 2008.</li>
            <li>Prescott K, Kinsella G. Psychosis-sensitive motivational interviewing: adapting motivational interviewing for individuals with psychotic disorders. *Front Psychol*. 2017;8:1702.</li>
          </ol>
        </div>
