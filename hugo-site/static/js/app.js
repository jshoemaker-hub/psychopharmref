...
function switchSection(id) {
  ...
  if (sec && sec.dataset.lazyTool && !sec.dataset.lazyLoaded) {
    ...
    link.rel = 'stylesheet';
    link.href = 'css/tools/' + toolId + '.css?v=20260718v';
    ...
    function loadToolScript() {
      ...
      if (toolId === 'question-bank-tool' && !window.QBANK_DATA) {
        ...
        dataScript.onload = function() {
          ...
          script.src = 'js/tools/' + toolId + '.js?v=20260718v';
        ...
        var deps = [
          'js/combination-strategies.js?v=20260718j',
          'js/receptor-actions.js?v=20260718j',
          'js/mechanism-tiers.js?v=20260718j',
          'js/pair-safety.js?v=20260718j',
    ...
    if (shouldLoadToolUtils()) {
      ...
      utils.src = 'js/tools/tool-utils.js?v=20260718v';
