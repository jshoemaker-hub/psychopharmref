...
const ANTIPSYCHOTIC_AE_RISK = {
  ...
  ziprasidone:   { lipid: 'low',   glucose: 'low',   eps: 'mod'  },
  aripiprazole:  { lipid: 'low',   glucose: 'low',   eps: 'mod'  },
  brexpiprazole: { lipid: 'low',   glucose: 'low',   eps: 'mod'  },
...
function switchSection(id, skipGroupExpand) {
  ...
  if (sec && sec.dataset.lazyTool && !sec.dataset.lazyLoaded) {
    ...
    link.rel = 'stylesheet';
    link.href = 'css/tools/' + toolId + '.css?v=20260918a';
    ...
    function loadToolScript() {
      ...
      if (toolId === 'question-bank-tool' && !window.QBANK_DATA) {
        ...
        var deps = [
          ...
          'js/symptom-domains.js?v=20260719d'
        ];
