...
1. **Choose a CSS prefix** — 2-3 letter abbreviation (check AGENTS.md prefix registry to avoid conflicts)
...
7. **Update AGENTS.md** — add the new CSS prefix to the registry
